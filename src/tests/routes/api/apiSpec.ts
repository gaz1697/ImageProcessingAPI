...
describe('testing api images processing functionality', (): void => {
  it('gets a jpeg/image in response to a correct request', async (): Promise<void> => {
  ...
  it('gets a 404 for a bad request', async (): Promise<void> => {
